...
using CourseViewModel = BigSchool.ViewModels.CourseViewModel;
...
namespace BigSchool.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
            ...
            var courses = _dbContext.Course.Single(c => c.Id == id && c.LecturerId == userId);
            var viewModel = new CourseViewModel
            {
                Categories = _dbContext.Categories.ToList(),
        ...
        public ActionResult Update(CourseViewModel viewModel)
        {
            ...
            var courses = _dbContext.Course.Single(c => c.Id == viewModel.Id && c.LecturerId == userId);
